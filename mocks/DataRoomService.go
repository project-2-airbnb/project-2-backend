...
// DataRoomService is an autogenerated mock type for the DataRoomService type
type DataRoomService struct {
	mock.Mock
}

// AddRoom provides a mock function with given fields: room
func (_m *DataRoomService) AddRoom(room rooms.Room) error {
	ret := _m.Called(room)
...
// DeleteRoom provides a mock function with given fields: roomid, userid
func (_m *DataRoomService) DeleteRoom(roomid uint, userid uint) error {
...
func (_m *DataRoomService) GetAllRooms() ([]rooms.Room, error) {
	ret := _m.Called()
...
func (_m *DataRoomService) GetRoomByName(roomName string) ([]rooms.Room, error) {
...
func (_m *DataRoomService) UpdateRoom(room rooms.Room) (rooms.Room, error) {
	ret := _m.Called(room)
...
// NewDataRoomService creates a new instance of DataRoomService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewDataRoomService(t interface {
	mock.TestingT
	Cleanup(func())
}) *DataRoomService {
